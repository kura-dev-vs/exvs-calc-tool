...
public class xb1500 {
	private String[][] ms= {
			{ "acguy", "アッガイ", "格闘_汎用1" },
			{ "gun_canon", "ガンキャノン", "射撃_汎用1" },
			{ "d_zaku2", "ザクⅡ(ドアン)", "格闘高補正" },
			{ "p2_qubeley", "キュベレイMk-Ⅱ(プルツー)", "射撃_汎用" },
			{ "rgz", "リ・ガズィ", "バランス_汎用" },
			{ "beruga_giros", "ベルガ・ギロス", "格闘_汎用1" },
			{ "gun_ez", "ガンイージ", "格闘_汎用1" },
			{ "rising", "ライジング", "ガンダムファイター" },
			{ "capule", "カプル(ソシエ)", "射撃_汎用1" },
			{ "lagowe", "ラゴゥ", "コーディネイター" },
			{ "baster", "バスター", "コーディネイター" },
			{ "duel", "デュエルAS", "コーディネイター" },
			{ "tieren_t2", "ティエレンタオツー", "射撃_汎用1" },
			{ "g_lucifer", "G-ルシファー", "月光蝶" },
			{ "alex", "アレックス", "格闘高補正" },
			{ "zaku2kai", "ザクⅡ改", "格闘_汎用1" },
			{ "ez8", "Ez8", "射撃_汎用1" },
			{ "gouf_custom", "グフ・カスタム", "格闘高補正" },
			{ "zudah", "ヅダ", "射撃_汎用1" },
			{ "hildolfr", "ヒルドルブ", "射撃_汎用1" },
			{ "ifrit", "イフリート改", "EXAM" },
			{ "supremacy", "スプレマシー", "格闘_汎用1" },
			};
	...
	public xb1500(String ms_val,InputStream is) throws EncryptedDocumentException, IOException {
		//this.is = is;
